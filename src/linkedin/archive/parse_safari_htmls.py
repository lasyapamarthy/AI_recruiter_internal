...
HTML_DIR = "/Users/emilpalikot/Research/AI-Recruiter/data/linkedin/output/safari_htmls"
OUTPUT_CSV = "/Users/emilpalikot/Research/AI-Recruiter/data/linkedin/output/safari_most_recent_experiences.csv"
OUTPUT_JSON = "/Users/emilpalikot/Research/AI-Recruiter/data/linkedin/output/safari_most_recent_experiences.json"
...
def extract_profile_name(soup):
    ...
    if title:
        ...
        # Pattern: "Name - Company | LinkedIn"
        if ' - ' in title_text and '| LinkedIn' in title_text:
            name_part = title_text.split(' - ')[0].strip()
            if name_part and name_part != 'LinkedIn':
                return name_part
